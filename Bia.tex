...
{\textbf{\Large{Xây dựng ứng dụng đặt người lái xe hộ}}\\[1cm]

{\textbf{\large{Triệu Tuyên Nhâm}}}\\
{\large{nham.tt204771@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Đỗ Tiến Dũng \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
  & \multicolumn{1}{r}{Chữ kí GVHD}     \\[0.5cm]
\textbf{Khoa:} & Kỹ thuật máy tính                 \\[0.5cm]
\textbf{Trường:} & Công nghệ Thông tin và Truyền thông \\[5cm]
\multicolumn{2}{c}{\textbf{HÀ NỘI, 12/2024}}                                            
\end{tabular}%
}
\end{table}}
\end{center}
